# Whitelist Calls - Android Call Screening App
...
Download this entire `WhitelistCalls` folder to your local machine.

### 2. Open in Android Studio

1. Open Android Studio
2. File → Open → Select the `WhitelistCalls` folder
...
3. Add an Android app:
   - Package name: `com.whitelistcalls.app`
...
├── service/
│   ├── WhitelistCallScreeningService.kt  # Core call screening
